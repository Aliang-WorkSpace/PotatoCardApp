...
在原项目基础上优化点：
1、图片：同一张图片再次传输时，会记住上次裁剪参数
2、天气：支持快捷指令推送天气、支持快捷指令推送天气、增加每小时自动更新开关。
3、天气：增加保护逻辑：只有上次投屏内容是天气时，才自动更新，避免覆盖照片/专辑/待办。
4、专辑：专辑内容从周杰伦/孙燕姿换成惘闻/黑帝、补充了对应专辑封面资源。
5、待办：修复输入完待办后键盘不自动收起的问题
6、图标：更换 App 图标
---
